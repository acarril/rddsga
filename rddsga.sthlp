...
{synopt :{opt block:bootstrap(varlist)}}specifies the variables identifying strata. If blockbootstrap() is specified, bootstrap samples are selected within each stratum. {p_end}
