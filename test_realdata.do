...
// Run command
rddsga ///
sh_licitacion dis_cutoff /// outcome and treatvar
p1 p2 p3 i.gpaoXuceXr /*sh_licitacionPRE2 sh_directoPRE1 sh_licitacionPRE1 sh_directoPRE2 size_PRE1 size_PRE2*/ I_PREaudit /// covariates
if (dis_cutoff2>-4 & dis_cutoff2<4), ///
  ...
  bwidth(10) subgroup(high_direct) c(0) treatment(I_CURaudit)
